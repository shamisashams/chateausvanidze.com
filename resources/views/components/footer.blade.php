    ...
    <div class="footer__top">
            ...
            <div class="footer__col">
                ...
                <p class="footer_p">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20.636" height="20" viewBox="0 0 11.636 14">
                        <g id="Icon_feather-map-pin" data-name="Icon feather-map-pin" transform="translate(-4 -1)">
                            <path fill="#fff" id="Path_55" data-name="Path 55"
                                  ...
                                  stroke-width="1"></path>
                            <path fill="#000" id="Path_56" data-name="Path 56"
                ...
                <p class="footer_p">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18.411" height="18.41" viewBox="0 0 18.411 18.41">
                        <path fill="#fff" id="Icon_ionic-ios-call" data-name="Icon ionic-ios-call"
                              ...
                              transform="translate(-4.49 -4.502)"></path>
                    </svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22.5" height="15.577" viewBox="0 0 22.5 15.577">
                        <g id="Icon_ionic-ios-mail" data-name="Icon ionic-ios-mail"
                           transform="translate(-3.375 -7.875)">
                            <path fill="#fff" id="Path_171" data-name="Path 171" class="cls-1"
                            ...
                            <path fill="#fff" id="Path_172" data-name="Path 172" class="cls-1"
        ...
        <div class="container" id="soc-container">
            <div class="soc-links" id="soc-column">
                ...
                <a href="{{count($pinterest->availableLanguage) > 0 ? $pinterest->availableLanguage[0]->value : ''}}"
                   target="_blank">
        ...
        <div class="footer-video-modal">
            <div class="footer-modal-wrap">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d8426.500043046433!2d44.80081624030541!3d41.694236682267714!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40440cd7e64f626b%3A0x61d084ede2576ea3!2sTbilisi%2C%20Georgia!5e0!3m2!1sen!2sus!4v1603197121014!5m2!1sen!2sus"
