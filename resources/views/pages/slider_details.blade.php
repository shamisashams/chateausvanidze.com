        ...
        <div class="container">
            ...
            <div class="details__preview">
                ...
                <div class="big-img-box {{($key == 0) ? 'shown' : ''}} ">
                    <img class="img-cover" src="{{asset('storage/slider/'.$data->id.'/'.$data->files[$key]->name)}}" alt="">
            ...
            <div class="details__complete-info">
                ...
                <div class="details__title">
                    {{$data->language()->where('language_id', $localization)->first()->title ?? ''}} <span>{{$data->language()->where('language_id', $localization)->first()->description ?? ''}}</span>
                </div>

                <div class="prices-actions">

                    <button class="details__add-to-cart" onclick="addToCartAjax({{$data->id}})">
                    ...
                    <button onclick="addToFav(this, '{{$data->id}}')" class="to-wishlist">
                ...
                <p class="details-description">
                    {{$data->language()->where('language_id', $localization)->first()->content ?? ''}}
                </p>
    ...
    <section id="offered-p">
     ...
     <div class="picture-modal">
        ...
        <div class="modal-img-content">
            ...
            <img id="modal-img" src="" alt="slider-picture">
        </div>
    </div>
