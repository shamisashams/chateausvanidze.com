...
@section('content')
    ...
    <div class="controls-above-table">
        <div class="row">
            <div class="col-sm-2">
                <a class="btn btn-lg btn-success" href="{{route('sliderCreateView',app()->getLocale())}}">@lang('admin.create_sliders')</a>
            </div>
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td class="row-actions d-flex">
                            ...
                            <a href="{{route('sliderEditView',[app()->getLocale(), $item->id])}}">
                                <i class="os-icon os-icon-ui-49">

                                </i>
                            </a>
                            {!! Form::open(['url' => route('sliderDestroy',[app()->getLocale(),$item->id]),'method' =>'delete']) !!}
