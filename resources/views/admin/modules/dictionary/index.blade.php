...
<div class="grid grid-cols-7">
    ...
    <div class="col-span-7 md:col-span-5">
        <form action="{{route('DictionaryStore', $locale)}}" method="POST" class="bg-white py-3 flex items-center justify-between justify-between px-4">
            ...
            <div>
                <h6 class="font-bold">
                    <input type="text" name="key" placeholder="Key" required class="focus:outline-none border p-0.5">
                </h6>
                <small class="font-normal"><input type="text" name="module" placeholder="module" required class="focus:outline-none border @error('module') border-red-500 @enderror p-0.5 mt-0.5"></small>
            </div>
            ...
            <form action="{{route('DictionaryIndex', $locale)}}" class="bg-white py-3 px-4 mt-2 flex items-center">
                <input type="text" value="{{$search}}" name="search" class="w-full focus:outline-none" placeholder="Search by Key..">
                <button type="submit">
            ...
            <div class="bg-white py-3 mt-2 flex items-center justify-between justify-between px-4">
                ...
                <form action="{{route('DictionaryUpdate', [app()->getLocale(),$item->id])}}" method="POST" class="flex w-full justify-between justify-between " >
                    ...
                    <div>
                        ...
                        <small class="font-normal">{{$item->module}}</small>
                    </div>
